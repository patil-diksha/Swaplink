...
//     e.preventDefault();
//     alert("Logging in with: " + JSON.stringify(formData));
//   };
...
//   }
//   @keyframes floatRotateScale2 {
//     0%, 100% { transform: translateY(0) rotate(0deg) scale(1); opacity: 0.25;}
//     50% { transform: translateY(-15px) rotate(-15deg) scale(0.95); opacity: 0.5;}
//   }
//   @keyframes floatRotateScale3 {
//     0%, 100% { transform: translateY(0) rotate(0deg) scale(1); opacity: 0.35;}
//     50% { transform: translateY(-25px) rotate(10deg) scale(1.05); opacity: 0.7;}
//   }
//   .floating-icon {
//     position: absolute;
//     font-size: 3rem;
...
//         <div
//           className="relative z-10 bg-white bg-opacity-60 backdrop-blur-md rounded-3xl shadow-xl max-w-md w-full p-10"
//           data-aos="fade-up"
//         >
...
//             <button
//               type="submit"
//               className="w-full bg-gradient-to-r from-green-600 to-yellow-400 text-white py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300"
//             >
//               Login
//             </button>
//           </form>
